...
commande::commande(int code,QString datecommande,QString type,int quantite,QString nom)
{ this->code=code;
 ...
 bool commande ::ajouter()
 {
     ...
     query .prepare("INSERT INTO commande(CODE,DATECOMMANDE,TYPE,QUANTITE,NOM)VALUES(:code,:datecommande,:type,:quantite,:nom)");
