...
public:
    ...
    void setupUi(QDialog *modifier_visite)
    {
        if (modifier_visite->objectName().isEmpty())
            modifier_visite->setObjectName(QStringLiteral("modifier_visite"));
        modifier_visite->resize(973, 822);
        modifier_visite->setStyleSheet(QStringLiteral("background-color: rgb(29, 30, 48);"));
...
"}"));
    ...
    {
        modifier_visite->setWindowTitle(QApplication::translate("modifier_visite", "Modfier visite", Q_NULLPTR));
        label_10->setText(QApplication::translate("modifier_visite", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">Pr\303\250nom patient</span></p></body></html>", Q_NULLPTR));
        label_11->setText(QApplication::translate("modifier_visite", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">Date naissance du patient</span></p></body></html>", Q_NULLPTR));
        label_14->setText(QApplication::translate("modifier_visite", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">Diagnostic</span></p></body></html>", Q_NULLPTR));
        label_9->setText(QApplication::translate("modifier_visite", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">Nom patient</span></p></body></html>", Q_NULLPTR));
        label_13->setText(QApplication::translate("modifier_visite", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">Observation</span></p></body></html>", Q_NULLPTR));
        label->setText(QApplication::translate("modifier_visite", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; text-decoration: underline; color:#ffffff;\">Modifier Visite</span></p></body></html>", Q_NULLPTR));
        pushButton->setText(QApplication::translate("modifier_visite", "Valider ", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("modifier_visite", "Annuler", Q_NULLPTR));
        label_15->setText(QApplication::translate("modifier_visite", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">ID_Visite</span></p></body></html>", Q_NULLPTR));
    } // retranslateUi
